 ...
 var dlabChartlist = function(){
	...
	var chartBar = function(){
		...
		shape: "circle",
			...
			xaxis: {
				position: 'bottom',
			  categories: ['DKI Jakarta', 'Kepulauan Seribu', 'Jawa Barat', 'Jawa Tengah', 'Jawa Timur', 'Bali', 'Kalimantan Tengah'],
			  labels: {
			   style: {
				  colors: '#787878',
				  fontSize: '13px',
	...
	var chartBar2 = function(){
		...
		shape: "circle",
			...
			xaxis: {
				 position: 'bottom',
			  categories: ['BLKK PONPES AL-AMIN', 'BLKK PONPES AL-ALAMIN', 'BLKK DARUL ULUM', 'BLKK DARUL IMLU', 'BLKK AZ-ZAHRA', 'BLKK ALHAMDULILLAH', 'BLKK AL-MANSHUR'],
			  labels: {
			   style: {
				  colors: '#787878',
				  fontSize: '13px',
